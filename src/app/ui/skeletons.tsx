...
export function ImportFilesSkeleton() {
  return (
    <div className="wrapper p-8 bg-white">
      ...
      <form className="form-group custom-form">
        <div className="flex flex-col md:flex-row items-stretch">
          ...
          <button
            type="button"
            className="px-6 py-2 hover:bg-white hover:border-gray-300 hover:text-gray-700 hover:transition-colors bg-gray-200 text-gray-500 border border-gray-200 transition-border rounded-md md:w-40 md:flex-shrink-0 text-center"
          >
      ...
      <div className="viewer mt-4 overflow-x-auto">
        <div className="table-responsive">
          <table className="table border-collapse border w-full">
            ...
            <tbody>
              {/* Repeat the skeleton rows based on the number of expected rows */}
      ...
      <div className="mt-4">
        ...
        <Skeleton height={120} className="border rounded p-2 w-full" />
